...
$router->get('/Ticket/list', [$TicketController, 'listeTicket']);
Flight::route('GET  /Ticket/historique', [$TicketController, 'historiqueMouvements']);

Flight::route('GET /dashboard', [$TicketController, 'dashboard']);
Flight::route('GET /api/dashboard/data', [$TicketController, 'getDashboardData']);
