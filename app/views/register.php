...
<div class="container">
    ...
    <form action="/register" method="POST" autocomplete="off">
        ...
        <div id="invitationField" style="display:none;">
            <input type="text" name="invitation_code" placeholder="Code d'invitation">
        </div>
...
document.getElementById('roleSelect').addEventListener('change', function() {
    let invitationField = document.getElementById('invitationField');
