...
<head>
    ...
    <title>Créer une offre d'emploi | VerdeDesign</title>
    <!-- Bootstrap CSS -->
...
<div class="form-container">
    ...
    <form method="POST" action="/offers/store" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="text" name="locations" placeholder="Lieu" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="diploma" placeholder="Diplôme requis">
        </div>

        <div class="form-group">
            <i class="fas fa-briefcase-medical input-icon"></i>
            <input type="text" name="experience_level" placeholder="Niveau d'expérience">
        </div>

        <div class="form-group">
            <i class="fas fa-gift input-icon"></i>
            <textarea name="benefits" placeholder="Avantages"></textarea>
        </div>
